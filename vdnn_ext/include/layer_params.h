...
struct DropoutLayerParams {
  ...
  void initializeValues(cudnnHandle_t cudnn_handle,
                        DropoutDescriptor *user_params,
                        cudnnDataType_t data_type, int batch_size,
                        cudnnTensorFormat_t tensor_format,
                        LayerDimension &output_size);

  void allocateSpace(size_t &free_bytes, cudnnHandle_t cudnn_handle,
...
struct BatchNormLayerParams {
  ...
  void initializeValues(BatchNormDescriptor *user_params,
                        cudnnDataType_t data_type,
                        cudnnTensorFormat_t tensor_format, int batch_size,
                        LayerDimension &output_size, UpdateRule update_rule);
  void allocateSpace(cudnnDataType_t data_type, size_t data_type_size,
