...
float Solver::step(int start_X, int start_y, std::vector<float> &fwd_vdnn_lag,
  ...
  // 										&Salpha,
  // 										(float *)cur_params->dscale,
  // 1,
  // 										(float *)cur_params->scale,
  // 1));
  // 				checkCUBLAS(cublasSaxpy(model->cublas_handle,
  // cur_params->sbmv_size,
  // 										&Salpha,
  // 										(float *)cur_params->dbias,
  // 1,
  // 										(float *)cur_params->bias,
  // 1));
  ...
  // cur_params->sbmv_size,
  // 										&Dalpha,
  // 										(double *)cur_params->dscale,
  // 1,
  // 										(double *)cur_params->scale,
  // 1));
  // 				checkCUBLAS(cublasDaxpy(model->cublas_handle,
  // cur_params->sbmv_size,
  // 										&Dalpha,
  // 										(double *)cur_params->dbias,
  // 1,
  // 										(double *)cur_params->bias,
  // 1));
